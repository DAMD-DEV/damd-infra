@php
  ...
  $image_pass   = 'product_images/suzuki/jimny_sierra_little-b/images/';
  $manual_pass  = 'product_images/suzuki/jimny_sierra_little-b/manual/';
@endphp
...
ジムニーをとことん遊べる一台に仕立てた<br>
「little B.」にシエラバージョンがついに登場！

<p>さぁ、「泥んこ」になって駆け回ろう！
</div>
<div class="bottom">
<img src="{{ asset($image_pass.'bg_arrow.png') }}" ></div>
</div>
...
<div id="sliderWrap">
<ul class="bxslider">
<li><img src="{{ asset($image_pass.'B0.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'B1.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'B2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'0L4A3189_1.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'0L4A3204_1.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'0L4A3179_1.jpg') }}" alt="" title=""></li>
</ul>
</ul>
<p class="caution">※ デモカーは製品と一部異なる仕様がございます。
<div id="bx-pager">
  <a data-slide-index="0" href=""><img src="{{ asset($image_pass.'B0.jpg') }}" alt=""></a>
  <a data-slide-index="1" href=""><img src="{{ asset($image_pass.'B1.jpg') }}" alt=""></a>
  <a data-slide-index="2" href=""><img src="{{ asset($image_pass.'B2.jpg') }}" alt=""></a>
  <a data-slide-index="3" href=""><img src="{{ asset($image_pass.'0L4A3189_1.jpg') }}" alt=""></a>
  <a data-slide-index="4" href=""><img src="{{ asset($image_pass.'0L4A3204_1.jpg') }}" alt=""></a>
  <a data-slide-index="5" href=""><img src="{{ asset($image_pass.'0L4A3179_1.jpg') }}" alt=""></a>
...
ボンネットフードカバー / フロントバンパ- / リアバンパ-＋エクステンション<br>
DEAN CROSS COUNTRY 5本セット【サイズ : 16×6J -5】<br>
<br>
（タイヤセットご注文の場合のみ）<br>
TOYO TIRE OPEN COUNTRY R/T ホワイトレター 5本セット<br>
【サイズ：215/65R16 C 109/107Q】<br>
<br>
※ ボディパーツはABS製 (グリルのみスチール製)<br>
※ グリルカラー：「シルバー」「半艶ブラック」から選択。<br>
※ ホイールカラーは下記の３色からご選択ください。<br>
　 「マーガレットホワイト」「マットブラック」「バーニッシュグレー」<br>
※ 塗装済み品の場合、<br>
...
<li><a href="{{ asset($image_pass.'9.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'9.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
...
<td class="price">¥448,000<span class="tax">¥（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1142">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥65,000<span class="tax">¥（税込）</span> </td>
<td class="button">&nbsp;</td>
</tr>
</table>
</div>
...
<div class="image">
<p class="text">
little B.の象徴とも言えるアイアングリルを、コットンホワイトで仕立てた APIO×DAMD だけの限定パッケージ。
OPEN COUNTRY R/T ホワイトレターとの相性も抜群。<br>
...
フロントバンパ- / リアバンパ-＋エクステンション<br>
APIO WILDBOAR SR 5本セット【サイズ : 16×6J -5】<br>
<br>
（タイヤセットご注文の場合のみ）<br>
TOYO TIRE OPEN COUNTRY R/T ホワイトレター 5本セット<br>
【サイズ：215/65R16 C 109/107Q】<br>
<br>
※ ボディパーツはABS製 (グリルのみスチール製)<br>
※ グリルカラーはコットンホワイトとなります。<br>
※ ホイールカラーは下記の３色からご選択ください。<br>
　 「マーガレットホワイト」「マットブラック」「バーニッシュグレー」<br>
※ 塗装済み品の場合、<br>
　 両側リアバンパーエクステンション部は全てマットブラックとなります。<br>
※ フロントバンパー装着に伴い、フェンダーの接合部と<br>
　 タイヤハウスインナーカバーのカット加工が必要となります。
<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 各パーツの詳細・注意事項は各パーツ項目にてご確認ください。<br>
...
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥468,000<span class="tax">¥（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1143">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥65,000<span class="tax">¥（税込）</span> </td>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'10.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'10.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥228,000<span class="tax">¥250,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1144">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<br>
※ ボディパーツはABS製 (ｸﾞﾘﾙのみｽﾁｰﾙ製)<br>
※ 塗装品の場合ﾌﾛﾝﾄｸﾞﾘﾙ・前後ﾊﾞﾝﾊﾟｰのｶﾗｰはｺｯﾄﾝﾎﾜｲﾄとなります。<br>
※ 塗装済み品の場合、<br>
...
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥248,000<span class="tax">¥272,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1145">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥65,000<span class="tax">¥71,500（税込）</span> </td>
...
<br>
フラットなセンターリブにはステッカーやエンブレムを貼ったりとちょっとしたカスタムも楽しみも1つ。

<span class="caution">
※ こちらの製品はAPIO様の商品となります。<br>
　 ご購入はリンク先のAPIO様にてお願いいたします。
</span>
</p>
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'0L4A3248_1.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A3248_1.jpg') }}" alt="" title=""></a></li>
</ul> 
</div>
<table class="list">
<tr>
...
<p class="title">DAMDアメリカンエンブレム <a href="{{ asset($manual_pass.'embrem.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'0L4A3263_1.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A3263_1.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'0L4A3243_1.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A3243_1.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<p class="title">リアバンパー＋エクステンション <a href="{{ asset($manual_pass.'jb74_jimny-roots_rb_ 201127.pdf') }}"><i class="fa fa-wrench"></i></a> <a href="{{ asset($manual_pass.'jb74_jimny-roots_rbext-201102.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'0L4A3236_1.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A3236_1.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1141">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<dd>2018.7〜								
<dt>ホイール
<dd>DEAN CROSS COUNTRY<br>
【サイズ : 16×6J -5】
<dt>タイヤ
<dd>
TOYO TIRE OPEN COUNTRY R/T<br>
【サイズ：215/65R16 C 109/107Q】
<dt>サスペンション	
<dd>-									
</dl>
</div>
...
<li>ﾌｫﾝｱｲﾎﾞﾘｰﾒﾀﾘｯｸ（ZVG）×粗目ﾏｯﾄﾌﾞﾗｯｸ"	
</ul>
...
<li><a href="{{ asset($image_pass.'color/littleB-ivory.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/littleB-ivory.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'color/littleB-sierra-blue.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/littleB-sierra-blue.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'color/littleB-sierra-gray.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/littleB-sierra-gray.jpg') }}" alt="" title=""></a></li>
</ul>
</section>
