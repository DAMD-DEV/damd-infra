@php
  ...
  $image_pass   = 'product_images/suzuki/jimny_little-d/images/';
  $manual_pass  = 'product_images/suzuki/jimny_little-d/manual/';
@endphp
...
<title>JIMNY “little D.” SUZUKI | エアロパーツ、ドレスアップのダムド | DAMD Inc.</title>
<meta http-equiv="content-style-type" content="text/css" />
<meta name="viewport" content="width=device-width,initial-scale=1.0" />

<meta property="og:title" content="JIMNY “little D.”｜SUZUKI | DAMD Inc."/>
<meta property="og:type" content="website"/>
<meta property="og:description" content="往年の名車ランドローバー ディフェンダーをモチーフにしたオマージュアイテム！憧れた名車を最新ジムニーで。"/>
<meta property="og:url" content="http://www.damd.co.jp/products/suzuki/jimny_little-d/"/>
<meta property="og:image" content="http://www.damd.co.jp/products/suzuki/jimny_little-d/images/01.jpg">
<meta property="og:site_name" content="エアロパーツ、ドレスアップのダムド | DAMD Inc."/>

<meta name="Keywords" content="JIMNY “little D.”,DAMD,SUZUKI" />
...
<div class="box title">
<h3>JIMNY “little D.”</h3>
</div>

<p>往年の名車をモチーフとした遊び心をくすぐるオマージュアイテム！<br>
憧れた名車を最新ジムニーで。
</p>

<div id="sliderWrap">
<ul class="bxslider">
<li><img src="{{ asset($image_pass.'little-D_FRONT_MAIN.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-D_FRONT_MAIN_2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-D_REAR_MAIN.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-D_FRONT.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-D_SIDE.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-D_REAR.jpg') }}" alt="" title=""></li>
...
<li><img src="{{ asset($image_pass.'little-D_S_C_G_1.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-D_S_C_BE_1.jpg') }}" alt="" title=""></li>
</ul>
<p class="caution">※イメージ画像です
<div id="bx-pager">
  <a data-slide-index="0" href=""><img src="{{ asset($image_pass.'little-D_FRONT_MAIN.jpg') }}" alt=""></a>
  <a data-slide-index="1" href=""><img src="{{ asset($image_pass.'little-D_FRONT_MAIN_2.jpg') }}" alt=""></a>
  <a data-slide-index="2" href=""><img src="{{ asset($image_pass.'little-D_REAR_MAIN.jpg') }}" alt=""></a>
  <a data-slide-index="3" href=""><img src="{{ asset($image_pass.'little-D_FRONT.jpg') }}" alt=""></a>
  <a data-slide-index="4" href=""><img src="{{ asset($image_pass.'little-D_SIDE.jpg') }}" alt=""></a>
  <a data-slide-index="5" href=""><img src="{{ asset($image_pass.'little-D_REAR.jpg') }}" alt=""></a>
  <a data-slide-index="6" href=""><img src="{{ asset($image_pass.'little-D_image_1.jpg') }}" alt=""></a>
  <a data-slide-index="7" href=""><img src="{{ asset($image_pass.'little-D_image_2.jpg') }}" alt=""></a>
  <a data-slide-index="8" href=""><img src="{{ asset($image_pass.'little-D_image_3.jpg') }}" alt=""></a>
  <a data-slide-index="9" href=""><img src="{{ asset($image_pass.'little-D_image_4.jpg') }}" alt=""></a>
  <a data-slide-index="10" href=""><img src="{{ asset($image_pass.'little-D_S_C_G_1.jpg') }}" alt=""></a>
  <a data-slide-index="11" href=""><img src="{{ asset($image_pass.'little-D_S_C_BE_1.jpg') }}" alt=""></a>
...
「DAMD little G. / little D.」<br>の最新情報をお知らせします！
...
<div class="banner center"><a href="/complete/tax/"><img src="{{ asset($image_pass.'bnr_little-D_K.jpg') }}" alt=""></a></div>
...
<p class="title">コンプリートキット &amp; DEAN little D edition<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
little D.の全てを盛り込んだ完全コンプリートパッケージ。<br>
DEAN little D. edition 5本を含んだスペシャルキットです。
<span class="caution">

【キット内容】<br>
ﾌﾛﾝﾄｸﾞﾘﾙ / ﾌﾛﾝﾄﾊﾞﾝﾊﾟ- / ﾘｱﾊﾞﾝﾊﾟ- / ﾌｪﾝﾀﾞ-ﾊﾟﾈﾙ<br>
ﾎﾞﾝﾈｯﾄﾌ-ﾄﾞ / ﾏｯﾄﾞﾌﾗｯﾌﾟ / little D. ﾚﾀ-ｴﾝﾌﾞﾚﾑ & ｵ-ﾊﾞﾙｴﾝﾌﾞﾚﾑ<br>
DEAN CROSS COUNTRY little D edition 5本ｾｯﾄ<br>
(ﾎｲｰﾙｻｲｽﾞ : 16×5.5J +20)<br>
<br>
...
※ 塗装済み品をご注文の場合、各ﾊﾟｰﾂの塗装は下記の通りとなります。<br>
&nbsp;&nbsp;&nbsp;【ﾎﾞﾝﾈｯﾄﾌｰﾄﾞｶﾊﾞｰ】 : 純正塗装色からご選択ください。<br>
&nbsp;&nbsp;&nbsp;【ﾌﾛﾝﾄｸﾞﾘﾙ】 : 粗目ﾏｯﾄﾌﾞﾗｯｸ、または純正色×粗目ﾏｯﾄﾌﾞﾗｯｸからご選択ください。<br>
&nbsp;&nbsp;&nbsp;(純正色×粗目ﾏｯﾄﾌﾞﾗｯｸは、ｸﾞﾘﾙｾﾝﾀ-外周部のみ純正色。）<br>
&nbsp;&nbsp;&nbsp;【ﾌﾛﾝﾄﾊﾞﾝﾊﾟｰ】 : 粗目ﾏｯﾄﾌﾞﾗｯｸ×ｶﾞﾝﾒﾀﾘｯｸの2色塗り分け<br>
&nbsp;&nbsp;&nbsp;【ﾌｪﾝﾀﾞｰﾊﾟﾈﾙ / ﾘｱﾊﾞﾝﾊﾟｰ】 : 粗目ﾏｯﾄﾌﾞﾗｯｸ<br>
※ 未塗装品をご選択された場合でも、ﾌﾛﾝﾄｸﾞﾘﾙのみﾏｯﾄﾌﾞﾗｯｸ塗装品となります。<br>
※ little D.ﾚﾀ-ｴﾝﾌﾞﾚﾑはｼﾙﾊﾞ- ・ ﾌﾞﾗｯｸからお選び下さい。<br>
※ ﾎｲｰﾙｷｬｯﾌﾟｶﾗｰは純正塗装色×ﾏｯﾄﾌﾞﾗｯｸとなります。<br>
※ ﾎｲｰﾙ本体のｶﾗｰはﾏｯﾄﾌﾞﾗｯｸのみとなります。<br>
※ 純正ﾊﾞｯｸｶﾒﾗ対応ｷｯﾄ付属<br>
※ ﾌｫｸﾞﾗﾝﾌﾟは純正を流用。<br>
...
※ 「ﾅﾝﾊﾞｰﾌﾟﾚｰﾄ移設ｷｯﾄ」は含まれておりません。<br>
&nbsp;&nbsp;&nbsp;ご希望のお客様は別途ご購入いただきますようお願い申し上げます。<br>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="944">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥78,000<span class="tax">¥85,800	（税込）</span>	</td>
<td class="button">&nbsp;</td>
</tr>
</table>
</div>
...
<p class="title">コンプリートキット & APIO WILD BOAR SR	 <!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
老舗ジムニー専門メーカー APIO社の人気ホイール。<br>
APIO WILDBOAR SR 5本セット含んだコンプリートパッケージ。
			
<span class="caution">
【キット内容】<br>
ﾌﾛﾝﾄｸﾞﾘﾙ / ﾌﾛﾝﾄﾊﾞﾝﾊﾟ- / ﾘｱﾊﾞﾝﾊﾟ- / ﾌｪﾝﾀﾞ-ﾊﾟﾈﾙ<br>
ﾎﾞﾝﾈｯﾄﾌ-ﾄﾞ / ﾏｯﾄﾞﾌﾗｯﾌﾟ / little D. ﾚﾀ-ｴﾝﾌﾞﾚﾑ & ｵ-ﾊﾞﾙｴﾝﾌﾞﾚﾑ<br>
APIO WILDBOAR SR 5本セット (ホイールサイズ : 16×5.5J +20)<br>
<br>
<span class="red">※ 本製品は、2024年1月以降受注を開始している<br>
&nbsp;&nbsp;&nbsp;&nbsp;ﾘｱﾊﾟｰｷﾝｸﾞｾﾝｻｰ＜ﾊﾞｯｸｿﾅｰ＞装着車には対応しておりません。<br>
&nbsp;&nbsp;&nbsp;&nbsp;ご注文際は必ずご確認いただきますようお願い申し上げます。
...
※ 未塗装品をご選択された場合でも、ﾌﾛﾝﾄｸﾞﾘﾙのみﾏｯﾄﾌﾞﾗｯｸ塗装品となります。<br>
※ little D.ﾚﾀ-ｴﾝﾌﾞﾚﾑはｼﾙﾊﾞ- ・ ﾌﾞﾗｯｸからお選び下さい。<br>
※ ﾎｲｰﾙｶﾗｰはｺｯﾄﾝﾎﾜｲﾄ/ｱｲｱﾝﾌﾞﾗｯｸからご選択下さい。<br>
※ 純正ﾊﾞｯｸｶﾒﾗ対応ｷｯﾄ付属<br>
※ ﾌｫｸﾞﾗﾝﾌﾟは純正を流用。<br>
&nbsp;&nbsp;&nbsp;(XGｸﾞﾚ-ﾄﾞへ装着する場合は別途ﾌｫｸﾞﾗﾝﾌﾟの購入が必要となります。）<br>
※ﾃﾞﾓｶｰでは、ｽﾍﾟｱﾎｲｰﾙを背面に向けるﾌﾞﾗｹｯﾄを使用しております。<br>
...
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥450,000<span class="tax">¥495,000（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="983">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥78,000<span class="tax">¥85,800（税込）</span>	</td>
...
<p class="title">コンプリートキット<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
エンブレムまで含めたボディキットのみのコンプリートキット。
※ ホイールは付属しておりません。
<span class="caution">
【キット内容】<br>
ﾌﾛﾝﾄｸﾞﾘﾙ / ﾌﾛﾝﾄﾊﾞﾝﾊﾟ- / ﾘｱﾊﾞﾝﾊﾟ-<br>
ﾌｪﾝﾀﾞ-ﾊﾟﾈﾙ / ﾎﾞﾝﾈｯﾄﾌ-ﾄﾞ / ﾏｯﾄﾌﾗｯﾌﾟ<br>
little D. ﾚﾀ-ｴﾝﾌﾞﾚﾑ & ｵ-ﾊﾞﾙｴﾝﾌﾞﾚﾑ<br>
<br>
<span class="red">※ 本製品は、2024年1月以降受注を開始している<br>
&nbsp;&nbsp;&nbsp;&nbsp;ﾘｱﾊﾟｰｷﾝｸﾞｾﾝｻｰ＜ﾊﾞｯｸｿﾅｰ＞装着車には対応しておりません。<br>
&nbsp;&nbsp;&nbsp;&nbsp;ご注文際は必ずご確認いただきますようお願い申し上げます。
...
※ ﾌｫｸﾞﾗﾝﾌﾟは純正を流用。<br>
&nbsp;&nbsp;&nbsp; (XGｸﾞﾚ-ﾄﾞへ装着する場合は別途ﾌｫｸﾞﾗﾝﾌﾟの購入が必要となります。）<br>
※ ｽﾍﾟｱﾎｲｰﾙを背面に向けて装着したい場合は、<br>
&nbsp;&nbsp;&nbsp; JB74用純正ｽﾍﾟｱﾀｲﾔﾏｳﾝﾄが必要となります。<br>
※ 純正バックカメラ対応キット付属<br>
※ 「ナンバープレート移設キット」は含まれておりません。<br>
&nbsp;&nbsp;&nbsp; ご希望のお客様は別途ご購入いただきますようお願い申し上げます。<br>
※ 各ﾊﾟｰﾂの詳細・注意事項は各ﾊﾟｰﾂ項目にてご確認ください。<br>
...
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥290,000<span class="tax">¥319,000（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="945">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥78,000<span class="tax">¥85,800（税込）</span> </td>
...
<p class="title">フロントグリル <a href="{{ asset($manual_pass.'jb64_74_D_grill_200309.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
くっきり凹凸のある造形で、クラシックな印象を与えるグリル。
両端には専用サイズで新たに開発した丸形ランプを付属。
<span class="caution">
※ little D.ｵ-ﾊﾞﾙｴﾝﾌﾞﾚﾑは付属致しません。別途ご購入下さい。<br>
※ ﾏｯﾄﾌﾞﾗｯｸ塗装品、または純正色×ﾏｯﾄﾌﾞﾗｯｸ塗装品からご選択ください。<br>
&nbsp;&nbsp;&nbsp; (純正色×ﾏｯﾄﾌﾞﾗｯｸは、ｸﾞﾘﾙｾﾝﾀ-外周部のみ純正色。）<br>
※ 網はﾌﾞﾗｯｸとなります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_FG.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_FG.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1199"> 見積もり</label>
<!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="item_name_sub">純正色×マットブラック塗装品</td>
<td class="price">¥59,000<span class="tax">¥64,900（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1200"> 見積もり</label>
<!--2019年 秋 発売開始予定--></td>
</tr>
</table>
<!--<table class="list">
...
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥48,000<span class="tax">¥52,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="946">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<p class="title">LEDアクセサリーランプキット <a href="{{ asset($manual_pass.'positionlamp.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
little D. フロントグリルに付属するクリアダミーランプを<br>
実際にアクセサリーランプとして点灯させる専用キット。
<span class="caution">
※ little D.フロントグリル専用のオプションアイテムとなります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 車両登録前の本パーツの架装はお控えください。
</span>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'DSC06782.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'DSC06782.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'DSC06788.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'DSC06788.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">&nbsp;</td>
<td class="price">¥7,800<span class="tax">¥8,580（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1222"> 見積もり</label>
<!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">フロントバンパー <a href="{{ asset($manual_pass.'jb64_D_front_bumper_231129.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
大幅にボリュームを抑えたデザインで、<br>
よりクラシックなフロントフェイスへ。<br>
塗装品は、あえて粗っぽさを残した<br>
粗目マットブラック塗装を施し、<br>
ジムニーらしい武骨で力強い表情にフェイスチェンジ。

<span class="caution">
※ 塗装色は粗目ﾏｯﾄﾌﾞﾗｯｸ×ｶﾞﾝﾒﾀのみとなります。<br>
※ 網はﾌﾞﾗｯｸとなります。<br>
※ ﾌｫｸﾞﾗﾝﾌﾟは純正を流用。<br>
&nbsp;&nbsp;&nbsp;  (XGｸﾞﾚ-ﾄﾞへ装着する場合は別途ﾌｫｸﾞﾗﾝﾌﾟの購入が必要となります。）<br>
※ 純正タイヤハウスカバーの一部カットが必要となります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 車両登録前の本パーツの架装はお控えください。
</span>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_FB.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_FB.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-D_FB_2.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_FB_2.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="947">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<p class="title">リアバンパー <a href="{{ asset($manual_pass.'jb64_D_rear_bumper_201221.pdf') }}"><i class="fa fa-wrench"></i></a> <a href="{{ asset($manual_pass.'jb64_74_D_licenseplate_kit_210521.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
フロントバンパーと共通コンセプトのリアバンパー。<br>
サイズと形状にこだわったオリジナル丸形ランプを付属し、<br>
リアビューをクラシックテイストに仕立てます。					
<span class="caution">
<span class="red">※ 本製品は、2024年1月以降受注を開始している<br>
&nbsp;&nbsp;&nbsp;&nbsp;ﾘｱﾊﾟｰｷﾝｸﾞｾﾝｻｰ＜ﾊﾞｯｸｿﾅｰ＞装着車には対応しておりません。<br>
&nbsp;&nbsp;&nbsp;&nbsp;ご注文際は必ずご確認いただきますようお願い申し上げます。
...
<br>
※ 塗装色は粗目ﾏｯﾄﾌﾞﾗｯｸ塗装のみとなります。<br>
※ 丸形ﾗﾝﾌﾟ/ﾘﾌﾚｸﾀ-/ﾅﾝﾊﾞ-ﾌﾟﾚ-ﾄﾍﾞ-ｽ付属。<br>
※ 純正インナーカバーの一部カットが必要となります。<br>
※ ﾊﾞｯｸｶﾒﾗ取付車は「ﾊﾞｯｸｶﾒﾗｷｯﾄ」の同時購入が必要。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 車両登録前の本パーツの架装はお控えください。	
</span>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_R_B.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_R_B.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="948">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥11,000<span class="tax">¥12,100（税込）</span> </td>
...
<p class="title">バックカメラキット<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
little D. リアバンパー"専用バックアイカメラ対応キット。
<span class="caution">
※ little D. リアバンパー専用のキットとなります。<br>
※ 純正ﾊﾞｯｸｶﾒﾗ専用設計となります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 車両登録前の本パーツの架装はお控えください。
</span>
...
<tr>
<td class="item_name_sub">&nbsp;</td>
<td class="price">¥3,800<span class="tax">¥4,180	（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="956">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>


<p class="title">ナンバープレート移設キット (little D.バンパー専用) <a href="{{ asset($manual_pass.'jb64_74_D_plate_relocation_kit_220311.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
ナンバープレートをリアドアに移設するオリジナルキット。<br>
こちらの商品は"little D. リアバンパー"専用アイテムとなります。
<span class="caution">
※ little D. リアバンパーに付属する<br>
&nbsp;&nbsp;&nbsp; ナンバープレートベースを利用した専用キットとなります。<br>
&nbsp;&nbsp;&nbsp; 純正リアバンパーには装着できません。<br>
※ 車両状態により、ナンバープレートの視認性を確保する為、<br>
&nbsp;&nbsp;&nbsp; スペアタイヤならびにブラケットの取り外しが必要となります。<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_L_P.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_L_P.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="957">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">ナンバープレート移設キット (純正バンパー専用) <a href="{{ asset($manual_pass.'jb64_74_D_plate_relocation_kit_220311.pdf') }}"><i class="fa fa-wrench"></i></a> <a href="{{ asset($manual_pass.'jb64_74_D_licenseplate_kit_210521.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
ナンバープレートをリアドアに移設するオリジナルキット。<br>
こちらは"純正リアバンパー"専用品となります。
<span class="caution">
※ 純正リアバンパー専用のアイテムとなります。<br>
&nbsp;&nbsp;&nbsp; little D. リアバンパーを装着済みのお客さまは、<br>
&nbsp;&nbsp;&nbsp; ナンバープレート移設キット (little D.ﾊﾞﾝﾊﾟｰ専用)」をご選択下さい。<br>
※ 車両状態により、ナンバープレートの視認性を確保する為、<br>
&nbsp;&nbsp;&nbsp; スペアタイヤならびにブラケットの取り外しが必要となります。<br>
&nbsp;&nbsp;&nbsp; 予めご了承上、購入をご検討ください。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 車両登録前の本パーツの架装はお控えください。</span>
</p>
<!--<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'Stainless-Window-Trim-Satin-silver.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'Stainless-Window-Trim-Satin-silver.jpg') }}" alt="" title=""></a></li>
</ul> -->
...
<tr>
<td class="item_name_sub">&nbsp;</td>
<td class="price">¥14,800<span class="tax">¥16,280（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="958">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">フェンダーパネル <a href="{{ asset($manual_pass.'jimny64_fender_panel.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
サイド部にボリューム与えるフェンダーパネル。<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_FP.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_FP.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥48,000<span class="tax">¥52,800（税込）</span> </td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="949">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<div class="image">
<p class="text">
中央部にボリュームを持たせ、正面のシルエットを力強く。<br>
オプションの"little D レターエンブレム"を装着すれば、<br>
よりクラシカルな雰囲気を醸し出します。
<br>
<span class="caution">
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_BF.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_BF.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥48,000<span class="tax">¥52,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="950">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<p class="title">マッドフラップ <a href="{{ asset($manual_pass.'jb64_74_D_madflap_wire_220222.pdf') }}"><i class="fa fa-wrench"></i></a> <a href="{{ asset($manual_pass.'jb64_D_madflap-220221.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
主流な材質を使わず、<br>
あえてクラシックな質感にこだわったゴム製マッドフラップ。<br>
車高を上げても見劣りしない長めのサイズ設定で、<br>
クラシック4WDの王道スタイルを。
<span class="caution">
※ little D. リアバンパー装着車専用アイテムとなります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ ノーマル車両装着時のマッドガード下端から地上までクリアランス<br>
&nbsp;&nbsp;&nbsp; FR : 約94mm / RR : 約137mm<br>
※ 車両登録前の本パーツの架装はお控えください。
</span>
</p>
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_M_F.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_M_F.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-D_M_F_2.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_M_F_2.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="951">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">little D レターエンブレム<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
ボンネットフード専用のlittle D.レターエンブレム。<br>
ボディ色に合わせてブラックかシルバーをご選択いただけます。
<span class="caution">
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
...
<table class="list">
<tr>
<td class="item_name_sub">マットブラック</td>
<td class="price">¥4,800<span class="tax">¥5,280（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="952">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="item_name_sub">シルバー</td>
<td class="price">¥4,800<span class="tax">¥5,280（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="953">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">little D オーバルエンブレム<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
little D.と刻まれたグリーンの楕円型エンブレム。<br>
ワンポイントのアクセントとして。

<span class="caution">
※ フロント用は固定具のある「little D. フロントグリル」専用品となります。<br>
&nbsp;&nbsp;&nbsp; ボディ等に両面テープでの装着を行う場合はリア用をご購入ください。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります
</span> 
</p>
...
<table class="list">
<tr>
<td class="item_name_sub">フロント用</td>
<td class="price">¥2,800<span class="tax">¥3,080（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="954">見積もり</label>
<!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="item_name_sub">リア用</td>
<td class="price">¥2,800<span class="tax">¥3,080（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1135">見積もり</label>
<!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">little D. AOLデカール	<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
デモカーに採用されていた<br>
「Adventure of a lifetime」デカールが、<br>
多くの little D. ファンからのリクエストで商品化。<br>
...
※ 左右1セットとなります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。</span>
</p>
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-D_Sticker.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-D_Sticker.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">&nbsp;</td>
<td class="price">¥28,000<span class="tax">¥30,800（税込）</span> </td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="985">見積もり</label><!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">DEAN CROSS COUNTRY little D edition<!-- <a href="{{ asset($manual_pass.'01.pdf') }}"><i class="fa fa-wrench"></i></a> -->【5本セット】</p>
<!--<p><img src="{{ asset($image_pass.'wheel_banner.jpg') }}" alt="" width="100%"> -->
<div class="detail">
<div class="image">
<p class="text">
クリムソン社製 不朽の名作 "DEAN CROSS COUNTRY"。<br>
そのホイールキャップを、ボディ色とマットブラックの<br>
ツートーンカラーに塗装した little D. だけの特別仕様。<br>
<span class="caution">
※ ﾎｲｰﾙ本体のｶﾗｰはﾏｯﾄﾌﾞﾗｯｸのみとなります。<br>
※ ﾃﾞﾓｶｰでは、ｽﾍﾟｱﾎｲｰﾙを背面に向けるﾌﾞﾗｹｯﾄを使用しております。<br>
&nbsp;&nbsp;&nbsp;背面ﾌﾞﾗｹｯﾄは付属しておりません。ご了承ください。<br>
...
<table class="list">
<tr>
<td class="item_name_sub">5本セット </td>
<td class="price">¥235,000<span class="tax">¥258,500	（税込）</span> </td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="955">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tbody class="main">
</tbody>
</table>
...
<p class="title">little D. シートカバー	<!-- <a href="{{ asset($manual_pass.'01.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
little Dのエクステリアに負けない、<br>
クラシックな生地を新たに調達。<br>
どこか懐かしくて、暖かいインテリア空間を演出します。<br>
<br>
チェックと千鳥柄の新規調達した生地は、<br>
ゼロから難燃加工を施し、<br>
サブマテリアルには耐久性に優れた本革調PVCを使用。<br>
<br>
現代の製品クオリティーとクラシックデザインが融合した<br>
オリジナリティ溢れるシートカバーに仕立てました。<br>

<span class="caution">※ XGグレードへの装着は不可となります。<br>
※ 別途送料·お取付業者様でのお取付工賃が発生致します。<br>
※ 各取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ お取り付け後の返品·ｷｬﾝｾﾙは不可となります。</span>
</p>
</div>
<table class="list">
<tr>
<td class="item_name_sub">GRAY×CHECKERED <a href="{{ asset($image_pass.'little-D_S_C_G_2.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i></a></td>
<td class="price">¥68,000<span class="tax">¥74,800（税込）</span></td>
<td class="button"><a href="https://damd.stores.jp/items/5d8372ea40043d57651858f1" target="_blank" class="btn size_ss">購入する</a><!--<label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="980">見積もり</label> --></td>
</tr>
<tr>
<td class="item_name_sub">BEIGE×HOUNDSTOOTH　<a href="{{ asset($image_pass.'little-D_S_C_BE_2.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i></a></td>
<td class="price">¥68,000<span class="tax">¥74,800（税込）</span></td>
<td class="button"><a href="https://damd.stores.jp/items/5d8373f81c77077dd228ff63" target="_blank" class="btn size_ss">購入する</a><!--<label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="979">見積もり</label> --></td>
</tr>
<tbody class="main">
</tbody>
</table>
...
<dd>2018.7〜
<dt>ホイール
<dd>CRIMSON INC. DEAN CROSS COUNTRY. 16inch × 5.5J
<dt>タイヤ
<dd>TOYO TIRE OPEN COUNTRY R/T 185/85R/16
<dt>サスペンション
<dd>APIO ROADWIN  A2000Ti
</dl>
</div>
...
<br>
塗装済商品の塗装色は、各自動車メーカー指定の色情報を元に調色を行った近似色となります。紫外線等によるボディ塗装面の日焼けや経年劣化等による各お客さまの車両状態、また新車であってもベースとなる下地素材の違い等複雑な条件により、色味に若干の誤差が発生する場合がございます。予めご了承ください。
<br>
<br>
色合わせについてご心配のお客様は、未塗装品をご購入の上、板金塗装工場等にて現車合わせによる塗装を推奨いたします。
</p>
</div>
...
<p class="center"><img src="{{ asset($image_pass.'colorsample_banner_D.jpg') }}" alt="" width="320"></p>
<ul class="list product column_3">
<li><a href="{{ asset($image_pass.'SIERRA_LITTLE-D_blue.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'SIERRA_LITTLE-D_blue.jpg') }}"></a></li>
<li><a href="{{ asset($image_pass.'JIMNY_LITTLE-D_silver.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'JIMNY_LITTLE-D_silver.jpg') }}"></a></li>
<li><a href="{{ asset($image_pass.'SIERRA_LITTLE-D_ivory.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'SIERRA_LITTLE-D_ivory.jpg') }}"></a></li>
<li><a href="{{ asset($image_pass.'SIERRA_LITTLE-D_black.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'SIERRA_LITTLE-D_black.jpg') }}"></a></li>
<li><a href="{{ asset($image_pass.'JIMNY_LITTLE-D_white.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'JIMNY_LITTLE-D_white.jpg') }}"></a></li>
<li><a href="{{ asset($image_pass.'JIMNY_LITTLE-D_yellow.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'JIMNY_LITTLE-D_yellow.jpg') }}"></a></li>
</ul>
</section>
