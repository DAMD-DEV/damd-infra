...
$item_cs_form_ary=array(1246,1247,1248,1240,1249,1243,1250,1251);
...
if($item_id==1246||$item_id==1247||$item_id==1248){
...
if($item_id==1246||$item_id==1247||$item_id==1248||$item_id==1251){
  $r_check_ay[1] = "確認しました";
