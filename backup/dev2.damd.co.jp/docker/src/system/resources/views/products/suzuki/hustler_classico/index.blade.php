@php
  ...
  $image_pass   = 'product_images/suzuki/hustler_classico/images/';
  $manual_pass  = 'product_images/suzuki/hustler_classico/manual/';
@endphp
...
<title>HUSTLER CLASSICO SUZUKI | エアロパーツ、ドレスアップのダムド | DAMD Inc.</title>
<meta http-equiv="content-style-type" content="text/css" />
<meta name="viewport" content="width=device-width,initial-scale=1.0" />

<meta property="og:title" content="HUSTLER CLASSICO｜SUZUKI | DAMD Inc."/>
...
<meta property="og:site_name" content="HUSTLER CLASSICO｜SUZUKI DAMD Inc."/>

<meta name="Keywords" content="HUSTLER CLASSICO,DAMD,SUZUKI" />
...
<div id="sliderWrap">
<ul class="bxslider">
<li><img src="{{ asset($image_pass.'classcio6-2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classcio3-roofblack.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classcio4.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico1-roofblack.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'0L4A6945.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'0L4A6977.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'0L4A6876.jpg') }}" alt="" title=""></li>

<li><img src="{{ asset($image_pass.'classico_response_3.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico_response_1_1.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico_response_1_2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico_response_2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico_response_4.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'classico_response_5.jpg') }}" alt="" title=""></li>
</ul>
<p class="caution">※ ルーフラックのカラーはブラックとなります。<div id="bx-pager">
  <a data-slide-index="0" href=""><img src="{{ asset($image_pass.'classcio6-2.jpg') }}" alt=""></a>
  <a data-slide-index="1" href=""><img src="{{ asset($image_pass.'classcio3-roofblack.jpg') }}" alt=""></a>
  <a data-slide-index="2" href=""><img src="{{ asset($image_pass.'classcio4.jpg') }}" alt=""></a>
  <a data-slide-index="3" href=""><img src="{{ asset($image_pass.'classico1-roofblack.jpg') }}" alt=""></a>
  <a data-slide-index="4" href=""><img src="{{ asset($image_pass.'classico2.jpg') }}" alt=""></a>
  <a data-slide-index="5" href=""><img src="{{ asset($image_pass.'0L4A6945.jpg') }}" alt=""></a>  
  <a data-slide-index="6" href=""><img src="{{ asset($image_pass.'0L4A6977.jpg') }}" alt=""></a>
  <a data-slide-index="7" href=""><img src="{{ asset($image_pass.'0L4A6876.jpg') }}" alt=""></a>
  
  <a data-slide-index="8" href=""><img src="{{ asset($image_pass.'classico_response_3.jpg') }}" alt=""></a>  
  <a data-slide-index="9" href=""><img src="{{ asset($image_pass.'classico_response_1_1.jpg') }}" alt=""></a>  
  <a data-slide-index="10" href=""><img src="{{ asset($image_pass.'classico_response_1_2.jpg') }}" alt=""></a>  
  <a data-slide-index="11" href=""><img src="{{ asset($image_pass.'classico_response_2.jpg') }}" alt=""></a>  
  <a data-slide-index="12" href=""><img src="{{ asset($image_pass.'classico_response_4.jpg') }}" alt=""></a>  
  <a data-slide-index="13" href=""><img src="{{ asset($image_pass.'classico_response_5.jpg') }}" alt=""></a>  
...
<li><a href="{{ asset($image_pass.'classico_exteriorkit.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'classico_exteriorkit.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'classico_canatabile.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'classico_canatabile.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1212">見積もり</label></td>
</tr>
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1211">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥65,000<span class="tax">¥71,500（税込）</span></td>
...
<p class="title">フェイスチェンジキット　<a href="https://storage.googleapis.com/img-damd-co-jp/2023/07/d80e851d06d8e9c6020e836fdffb32fa.pdf"><i class="fa fa-wrench"></i></a> <!--<a href="https://storage.googleapis.com/img-damd-co-jp/2023/07/d8b8ea33280cb7b8d26a15fdcb3bc7a7-1.pdf">--><a href="{{ asset($manual_pass.'hustler_BG.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
ヘッドランプを囲む懐かしいグリルデザインと、<br>
クロスオーバーコンパクトが掛け合わさった<br>
斬新なスタイリングが印象的なフェイスチェンジキット。


 <span class="caution">
【キット内容】<br>
ﾎﾞﾝﾈｯﾄﾌｰﾄﾞ / ﾌﾛﾝﾄｸﾞﾘﾙ<br>
ﾌﾛﾝﾄﾊﾞﾝﾊﾟｰ / 純正 SUZUKI ｸﾗｼｯｸｴﾝﾌﾞﾚﾑ<br>
<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 塗装済み品の場合、各ﾊﾟｰﾂの塗り分けは下記のとおりとなります。<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'0L4A7452-small.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A7452-small.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1148">見積もり</label> </td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥65,000<span class="tax">¥71,500（税込）</span></td>
...
<p class="title">テールランプガーニッシュ　<a href="https://storage.googleapis.com/img-damd-co-jp/2023/07/8c83de40a89bfcb9a38e9226bbceee04-2.pdf"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
...
<ul class="photo clearfix">
<!--<li><a href="{{ asset($image_pass.'CARABINA_khaki_2.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'CARABINA_khaki_2.jpg') }}" alt="" title=""></a></ -->
...
<p class="title">シートカバー CLASSICO</p>
<div class="detail">
<div class="image">
<p class="text">
懐かしく、優しい風合いのチェック柄生地に、<br>
ライトグレーの本革調PVCをコーディネート。<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'0L4A7424.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A7424.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'0L4A7418.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'0L4A7418.jpg') }}" alt="" title=""></a></li>
</ul>
</div><!--image -->
<table class="list">
<tr>
<td class="item_name_sub">GRAY×CHECKED</td>
<td class="price">¥58,000<span class="tax">¥63,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1149">見積もり</label></td>
</tr>
</table>
</div><!--detail -->
...
<dt>タイヤ
<dd>
NANGKANG ECO-2＋ 165/60R15 77H WR	
<dt>サスペンション		
<dd>-					
</dl>
</div>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/6HKQ_F7qGlc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
<li><a href="{{ asset($image_pass.'color/classcio1.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/classcio1.jpg') }}" alt="" title=""></a></li>
<!--<li><a href="{{ asset($image_pass.'color/classcio2.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/classcio2.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'color/classcio3.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/classcio3.jpg') }}" alt="" title=""></a></li>-->
<li><a href="{{ asset($image_pass.'color/classcio4.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/classcio4.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'color/classcio5.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/classcio5.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'color/classcio6.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/classcio6.jpg') }}" alt="" title=""></a></li>
</ul>
</section>
