@php
  ...
  $image_pass   = 'product_images/suzuki/jimny_theroots/images/';
  $manual_pass  = 'product_images/suzuki/jimny_theroots/manual/';
@endphp
...
<div class="text">
<p class="logo"><img src="{{ asset($image_pass.'logo.png') }}" alt=""></p> <!--                       <img src="{{ asset($image_pass.'R-main.jpg') }}" alt="" title="">-->
<p class="catch">"ブレない。"という美学。
<p>1970年から発売され、世界中を魅了し続ける車「スズキジムニー」

<p>そこに宿る魂を表現した JIMNY the ROOTS は、<br>
ジムニーを知り尽くした専門パーツメーカーのAPIOと共に<br>
原点となるジムニーの美しいフォルムを<br>
もう一度見つめ直した<br>
愛情溢れるボディキットです。			
</div>
...
<div id="sliderWrap">
<ul class="bxslider">
<li><img src="{{ asset($image_pass.'R-main.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'R-rear45.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'R-standard.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'R-main2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'roots-fornt.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'roots-side.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'roots-rear.jpg') }}" alt="" title=""></li>

<li><img src="{{ asset($image_pass.'color/i_wh.jpg') }}" alt="" title=""></li>
...
<li><img src="{{ asset($image_pass.'color/blu_sil.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'color/wh_bl.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'color/gre_wh.jpg') }}" alt="" title=""></li>
</ul>
<p class="caution">※ 画像はCGとなります。
<div id="bx-pager">
  <a data-slide-index="0" href=""><img src="{{ asset($image_pass.'R-main.jpg') }}" alt=""></a>
  <a data-slide-index="1" href=""><img src="{{ asset($image_pass.'R-rear45.jpg') }}" alt=""></a>
  <a data-slide-index="2" href=""><img src="{{ asset($image_pass.'R-standard.jpg') }}" alt=""></a>
  <a data-slide-index="3" href=""><img src="{{ asset($image_pass.'R-main2.jpg') }}" alt=""></a>
  <a data-slide-index="4" href=""><img src="{{ asset($image_pass.'roots-fornt.jpg') }}" alt=""></a>
  <a data-slide-index="5" href=""><img src="{{ asset($image_pass.'roots-side.jpg') }}" alt=""></a>
  <a data-slide-index="6" href=""><img src="{{ asset($image_pass.'roots-rear.jpg') }}" alt=""></a>
  <a data-slide-index="7" href=""><img src="{{ asset($image_pass.'color/i_wh.jpg') }}" alt=""></a>
  <a data-slide-index="8" href=""><img src="{{ asset($image_pass.'color/ye_wh.jpg') }}" alt=""></a>
  <a data-slide-index="9" href=""><img src="{{ asset($image_pass.'color/gr_bl.jpg') }}" alt=""></a>
  <a data-slide-index="10" href=""><img src="{{ asset($image_pass.'color/sil_sil.jpg') }}" alt=""></a>
  <a data-slide-index="11" href=""><img src="{{ asset($image_pass.'color/bl_sil.jpg') }}" alt=""></a>
  <a data-slide-index="12" href=""><img src="{{ asset($image_pass.'color/blu_sil.jpg') }}" alt=""></a>
  <a data-slide-index="13" href=""><img src="{{ asset($image_pass.'color/wh_bl.jpg') }}" alt=""></a>
  <a data-slide-index="14" href=""><img src="{{ asset($image_pass.'color/gre_wh.jpg') }}" alt=""></a>
</div>
...
ホイール・タイヤセットには、レトロなタイヤパターンが印象的なブリジストン社製のDUELERを選択。
...
<br>
（タイヤセットご注文の場合のみ）<br>
BRIDGESTONE DUELER M/T 674【サイズ：185/85R16 105/103L LT】<br>
<br>
...
　  ｺﾝﾌﾟﾘｰﾄｷｯﾄには背面ﾌﾞﾗｹｯﾄは付属しておりません。ご了承ください。<br>
...
<li><a href="{{ asset($image_pass.'R-completekit.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'R-completekit.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
...
<td class="price">¥320,000<span class="tax">¥352,000（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1112">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥57,000<span class="tax">¥62,700（税込）</span> </td>
<td class="button">&nbsp;</td>
</tr>
</table>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1113">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥57,000<span class="tax">¥62,700（税込）</span> </td>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'R-3pieceskit.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'R-3pieceskit.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1114">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥57,000<span class="tax">¥62,700（税込）</span>	</td>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'R-grill.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'R-grill.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'R-frontbumper.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'R-frontbumper.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<p class="title">リアバンパー <a href="{{ asset($manual_pass.'64jimny-roots_rb-web.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'R-rearbumper.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'R-rearbumper.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="1117">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥23,000<span class="tax">¥25,300（税込）</span> </td>
...
<li>粗目シルバー×粗目マットブラック
<li>粗目マットブラック×ガンメタ	
<li>ジャングルグリーン（ZZC）×粗目マットブラック
<li>ミディアムグレー（ZVL）×粗目マットブラック
<li>シフォンアイボリーメタリック（ZVG）×粗目マットブラック	-->	
<li>ｺｯﾄﾝﾎﾜｲﾄ×粗目ﾏｯﾄﾌﾞﾗｯｸ
<li>粗目ｼﾙﾊﾞｰ×粗目ﾏｯﾄﾌﾞﾗｯｸ
<li>粗目ﾏｯﾄﾌﾞﾗｯｸ×ｶﾞﾝﾒﾀ	
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Vzoj18-KiLM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
<li><a href="{{ asset($image_pass.'color/i_wh.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/i_wh.jpg') }}" alt="" title=""></a></li>
...
<li><a href="{{ asset($image_pass.'color/blu_sil.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/blu_sil.jpg') }}" alt="" title=""></a></li>
...
<li><a href="{{ asset($image_pass.'color/gre_wh.jpg') }}" class="fancybox" rel="color"><img src="{{ asset($image_pass.'color/gre_wh.jpg') }}" alt="" title=""></a></li>
</ul>

<p class="center catch">リアも含む、その他カラーパターンは動画で！
<div class="movie-wrap clear">
<iframe width="560" height="315" src="https://www.youtube.com/embed/xSV47fjwtVo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
