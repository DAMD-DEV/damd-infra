...
$item_cs_form_ary=array(1118,1119,1120,1128,1121,1122,1125,1126,1127);
...
}elseif($item_id==1118 || $item_id==1119){
...
}elseif($item_id==1120 || $item_id==1128){
  ...
  if($item_paint!=2){
    ...
    //ーーーーボンネットフードカバー　ーーーーーー
      ...
      <div style="line-height:1.3em;">
        ...
        ※フロントグリル、前後バンパー、ホイールのカラーはコットンホワイトになります。
        
        </small>
        
        <input type="hidden" name="user_color_info" value="※フロントグリル、前後バンパー、ホイールのカラーはコットンホワイトになります。">
...
if($item_id==1118||$item_id==1119||$item_id==1120||$item_id==1128||$item_id==1121||$item_id==1122||$item_id==1127){
  $r_check_ay[1] = "確認しました";
