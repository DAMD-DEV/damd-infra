...
$item_cs_form_ary=array(966,935,932,930,934,936,918,1291);
...
if($item_mount==1){
  ...
  $car_info_title_ary[3] = "リアバンパーについて";
  ...
  $required_request_item_ary[3] = "r_check";

  //確認画面用

  $car_info_confirm_ary[] = $car_info_title_ary[3].'：'.$r_check_ay[$r_check[0]];
...
}else if($item_id==930 or $item_id== 936){
...
if($item_paint!=2){
  ...
  <select name="r_color" class="form-control" required>

  '.getOptionHtml2($colorA,$r_color).'

  </select>

  ';

  $required_request[] = "r_color";

  $required_request_item_ary[1] = "r_color";

  //確認画面用

  $car_info_confirm_ary[] =  $car_info_title_ary[1].'：'.$r_color;
  ...
  '.getOptionHtml2($colorA2,$user_color).'
