@php
  ...
  $image_pass   = 'product_images/suzuki/jimny_sierra_little-g/images/';
  $manual_pass  = 'product_images/suzuki/jimny_sierra_little-g/manual/';
@endphp
...
<title>JIMNY SIERRA  “little G. STANDARD” SUZUKI | エアロパーツ、ドレスアップのダムド | DAMD Inc.</title>
<meta http-equiv="content-style-type" content="text/css" />
<meta name="viewport" content="width=device-width,initial-scale=1.0" />

<meta property="og:title" content="JIMNY SIERRA  “little G. STANDARD”｜SUZUKI | DAMD Inc."/>
<meta property="og:type" content="website"/>
<meta property="og:description" content="細部までこだわりぬいたアイテムでベビーGの愛称をそのままパッケージ！ダムドが放つ、ジムニーのオマージュカスタム。 "/>
<meta property="og:url" content="https://www.damd.co.jp/products/suzuki/jimny_sierra_little-g_sierra/"/>
<meta property="og:image" content="https://www.damd.co.jp/products/suzuki/jimny_sierra_little-g/images/01-2.jpg"/>
<meta property="og:site_name" content="JIMNY SIERRA  “little G. STANDARD”｜SUZUKI | DAMD Inc."/>
...
<div class="box title">
<h3>JIMNY SIERRA  “little G. STANDARD”</h3>
</div>
...
<div id="sliderWrap">
<ul class="bxslider">
<li><img src="{{ asset($image_pass.'little-G-SIERRA_FRONT_MAIN3.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-G-SIERRA_FRONT_MAIN2.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-G-SIERRA_REAR_MAIN.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-G-SIERRA_FRONT.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-G-SIERRA_SIDE.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-G-SIERRA_REAR.jpg') }}" alt="" title=""></li>
<li><img src="{{ asset($image_pass.'little-G-SIERRA_image.jpg') }}" alt="" title=""></li>
</ul>
<p class="caution">※イメージ画像です
<div id="bx-pager">

  <a data-slide-index="0" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_FRONT_MAIN3.jpg') }}" alt=""></a>
  <a data-slide-index="1" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_FRONT_MAIN2.jpg') }}" alt=""></a>
  <a data-slide-index="2" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_REAR_MAIN.jpg') }}" alt=""></a>
  <a data-slide-index="3" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_FRONT.jpg') }}" alt=""></a>
  <a data-slide-index="4" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_SIDE.jpg') }}" alt=""></a>
  <a data-slide-index="5" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_REAR.jpg') }}" alt=""></a>
  <a data-slide-index="6" href=""><img src="{{ asset($image_pass.'little-G-SIERRA_image.jpg') }}" alt=""></a>
</div>
</div>
...
<div class="banner center"><a href="/complete/tax/"><img src="{{ asset($image_pass.'bnr_little-G_SIERRA.jpg') }}" alt=""></a></div>
...
<p class="title">little G. STANDARD コンプリートキット &amp; &quot;little G&quot; ホイール</p>
<div class="detail">
<div class="image">
<p class="text">
...
G15エンブレム / little G. WHEEL 4本セット 【サイズ : 16×6J -5】<br>
<br>
【リアバンパーについて】<br>
...
※ 純正タイヤの巻き替えは出来ません。別途タイヤの購入が必要です。<br>
...
<table class="list">
<!--<tr>
<td class="item_name_sub">未塗装品素地【ホイール５本】</td>
<td class="price">¥410,000<span class="tax">¥（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="931">見積もり</label></td>
</tr> -->
<tr>
<td class="item_name_sub">未塗装品素地<br>
【ホイール4本】</td>
<td class="price">¥380,000<span class="tax">¥418,000（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="966">見積もり</label></td>
</tr>
<tr>
<td class="option">&nbsp;</td>
<td class="price option">&nbsp;</td>
<td class="button">&nbsp;</td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥70,000<span class="tax">¥77,000（税込）</span>	</td>
<td class="button">&nbsp;</td>
</tr>
<tr class=" en_none">
<td class="item_name_sub">純正リアバンパー (塗装済品)</td>
<td class="price">¥78,000<span class="tax">¥85,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="935">見積もり</label></td>
</tr>
</table>
</div>
...
※ボディキットのみとなり、ホイールは付属していません。
<span class="caution">
【キット内容】<br>
フロントグリル / フロントバンパ- / オーバーフェンダー&アルミステップ<br>
サイドモ-ル / スペアタイヤカバ- ＜ステンレスバンド＞ / G15エンブレム
<br>
<br>
【リアバンパーについて】<br>
イメージ画像ならびに弊社デモカーでは、<br>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="932">見積もり</label></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥70,000<span class="tax">¥77,000（税込）</span> </td>
...
<li><a href="{{ asset($image_pass.'little-G-SIERRA_FG.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_FG.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-G-SIERRA_FG2.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_FG2.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-G-SIERRA_FG3.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_FG3.jpg') }}" alt="" title=""></a></li></ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">未塗装品素地</td>
...
<p class="title">little G. STANDARD フロントバンパー for SIERRA <a href="{{ asset($manual_pass.'jb74_G_front_bumper_231006.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
...
<span class="caution">
※ ｵ-ﾊﾞ-ﾌｪﾝﾀﾞ-&ｱﾙﾐｽﾃｯﾌﾟtype-1同時装着専用になります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ 網はブラックとなります。<br>
※ フォグランプは純正を流用。<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-G-SIERRA_FB.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_FB.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="934">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
...
<div class="en_none">
<p class="title">純正リアバンパー (純正塗装済品) for SIERRA<!--<a href="{{ asset($manual_pass.'05.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
<div class="image">
<p class="text">
純正リアバンパーのシボを落とし、<br>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-G-SIERRA_RB.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_RB.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="price">¥78,000<span class="tax">¥85,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="935">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
</div>
...
<p class="title">オーバーフェンダー &amp; アルミステップ type-1 <a href="{{ asset($manual_pass.'jb74_G_AL_step_231006.pdf') }}"><i class="fa fa-wrench"></i></a> <a href="{{ asset($manual_pass.'jb74_G_OF_rubber_231006.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
サイド部に力強いボリュームを与える、<br>
オーバーフェンダーとアルミステップの豪華キット。<br>
印象的なホイールアーチはたくましく、<br>
そして美しいサイドプロポーション生み出します。

<span class="caution">
※ little G. STANDARD ﾌﾛﾝﾄﾊﾞﾝﾊﾟｰ同時装着専用になります。<br>
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ アルミステップのブラケット取付けに際し、<br>
　 ボディ下部に穴開け加工が必要となります。<br>
※ 塗装・お取付後のキャンセル・返品・交換はお受けできかねます。					
</span>
</p>
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-G-SIERRA_OF.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_OF.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-G-SIERRA_AS.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_AS.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
<td class="item_name_sub">未塗装品素地</td>
<td class="price">¥108,000<span class="tax">¥118,800（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="936">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
<tr>
<td class="option">別途塗装代</td>
<td class="price option"><i class="fa fa-plus-circle"></i> ¥25,000<span class="tax">¥27,500（税込）</span> </td>
<td class="button">&nbsp;</td>
</tr>
</table>
</div>
...
<!--
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-G_sierra_T-C.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G_sierra_T-C.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-G_T-C_black.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G_T-C_black.jpg') }}" alt="" title=""></a></li>
</ul>
-->
</div>
<table class="list">
<tr>
<td class="item_name_sub">未塗装品素地 / ステンレスバンド　<a href="{{ asset($image_pass.'little-G_sierra_T-C.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i></a></td>
<td class="price">¥58,000<span class="tax">¥63,800（税込）</span></td>
...
<tr>
<td class="item_name_sub">未塗装品素地 / ブラックバンド　<a href="{{ asset($image_pass.'little-G_T-C_black.jpg') }}" class="fancybox" title="" rel="gallery"><i class="fa fa-camera-retro"></i></a></td>
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-G-SIERRA_SM.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_SM.jpg') }}" alt="" title=""></a></li>
<li><a href="{{ asset($image_pass.'little-G-SIERRA_S_M2.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_S_M2.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<p class="title">G15エンブレム <a href="{{ asset($manual_pass.'jb64_74_G_emblem_1012.pdf') }}"><i class="fa fa-wrench"></i></a></p>
<div class="detail">
<div class="image">
<p class="text">
遊び心を忘れないアナタに。<br>
G15エンブレムで作り込まれたリアビューを。
<span class="caution">
※ 別途送料・お取付業者様でのお取付工賃が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
※ お取付後のキャンセル・返品・交換はお受けできかねます。
...
<ul class="photo clearfix">
<li><a href="{{ asset($image_pass.'little-G-SIERRA_G15.jpg') }}" class="fancybox" title="" rel="sheetcover"><i class="fa fa-camera-retro"></i><img src="{{ asset($image_pass.'little-G-SIERRA_G15.jpg') }}" alt="" title=""></a></li>
</ul>
</div>
<table class="list">
<tr>
...
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="937">見積もり</label> <!--2019年 秋 発売開始予定--></td>
</tr>
</table>
</div>
...
<p class="title">little G ホイール ( 16×6J -5 )	 <!-- <a href="{{ asset($manual_pass.'01.pdf') }}"><i class="fa fa-wrench"></i></a> --></p>
<div class="detail">
...
バランスの取れたインチアップにより迫力のあるスタイルへ。
<span class="caution">
※ 価格はホイールのみの税別価格となります。<br>
※ 個人宅への配送は不可となります。予めご了承下さい。<br>
※ １本〜３本のご注文の場合、別途送料が発生致します。<br>
※ 沖縄・離島へお届けの場合、送料は着払いとなります。<br>
　 (5本セット、4本セットも送料が発生致します。)<br>
※ 純正タイヤの巻き替えは出来ません。別途タイヤの購入が必要です。<br>
　 デモカー装着タイヤ BRIDGESTONE ALENZA001 215/65R/16<br>
※ お取付後のキャンセル・返品・交換はお受けできかねます。	
</span>			
</p>
<ul class="photo clearfix">
<li>
<a href="{{ asset($image_pass.'little-G-SIERRA_Gwheel_S.jpg') }}" class="fancybox" title="" rel=""><img src="{{ asset($image_pass.'little-G-SIERRA_Gwheel_S.jpg') }}"><i class="fa fa-camera-retro"></i></a>
</li>
<li>
<a href="{{ asset($image_pass.'little-G-SIERRA_Gwheel_B.jpg') }}" class="fancybox" title="" rel=""><img src="{{ asset($image_pass.'little-G-SIERRA_Gwheel_B.jpg') }}"><i class="fa fa-camera-retro"></i></a>
</li>
<!--<li>
...
<td class="price">¥165,000<span class="tax">¥181,500（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="938">見積もり</label></td>
</tr>
<tr>
<td class="item_name_sub">ブラック </td>
<td class="price">¥170,000<span class="tax">¥187,000（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="939">見積もり</label> </td>
</tr>
<tbody class="main">
</tbody>
</table>
...
<tr>
<td class="item_name_sub">シルバー</td>
<td class="price">¥132,000<span class="tax">¥145,200（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="940">見積もり</label></td>
</tr>
<tr>
<td class="item_name_sub">ブラック </td>
<td class="price">¥136,000<span class="tax">¥149,600（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="941">見積もり</label></td>
</tr>
<tbody class="main">
</tbody>
</table>
...
<tr>
<td class="item_name_sub">シルバー</td>
<td class="price">¥33,000<span class="tax">¥36,300（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="942">見積もり</label></td>
</tr>
<tr>
<td class="item_name_sub">ブラック </td>
<td class="price">¥34,000<span class="tax">¥37,400（税込）</span></td>
<td class="button"><label for="modal-trigger" class="btn size_ss mitsumori" data-item_id="943">見積もり</label></td>
</tr>
<tbody class="main">
</tbody>
</table>
...
<dd>2018.7〜
<dt>ホイール
<dd>DAMD little G Wheel 16inch×6J -5
<dt>タイヤ
<dd>BRIDGESTONE ALENZA LX100 215/70R/16
<dt>サスペンション
<dd>-
</dl>
</div>
