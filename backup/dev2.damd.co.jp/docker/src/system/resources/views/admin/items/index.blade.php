...
@section('main')
    ...
    <div class="clearfix mb-4">
        <a href="{{ route('admin.items.create') }}" class="btn btn-primary float-end">追加</a>
    </div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="card mb-3">
						...
						<div class="p-3">
							&lt;label for=&quot;modal-trigger&quot; class=&quot;btn size_ss mitsumori&quot; data-item_id=&quot;<span class="item_id">1506</span>&quot;&gt;見積もり&lt;/label&gt;
						</div>
					</div>
					<table class="table">
						<tbody>
				...
				<div class="modal-footer">
					{!! Form::open(['url' => route('admin.factories.destroy', 'number'), 'method' => 'delete', 'class' => 'd-inline delete-btn']) !!}
	...
	<script>
		$(function(){
			$('.list-group-item').click(function(){
				...
				$('#testModal').find('.item_id').text($item_id);
				...
				$edit_url = @json(route('admin.items.edit', 'number'));
				$edit_url = $edit_url.replace('number', $item_id);
				$('#testModal').find('.edit-btn').attr('href', $edit_url);

				$delete_url = @json(route('admin.items.destroy', 'number'));
