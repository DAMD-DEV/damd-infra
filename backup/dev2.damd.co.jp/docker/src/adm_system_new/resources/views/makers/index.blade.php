...
@section('main')
    <h1>メーカー</h1>
    <div class="clearfix">
        <a href="{{ route('makers.create') }}" class="btn btn-primary float-end">追加</a>
    </div>
    <div>
        <h2>メーカー一覧</h2>
        {{ $makers->links() }}
        <div class="main-list list-group">
            @foreach($makers as $maker)
                <div href="" class="list-group-item" data-bs-toggle="modal" data-bs-target="#testModal" data-maker-id={{ $maker->id }} data-name="{{ $maker->name }}" data-code="{{ $maker->code }}" data-car-maker="{{ $maker->car_maker }}" data-display="{{ $maker->display }}">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					{!! Form::open(['url' => route('makers.destroy', 'number'), 'method' => 'delete', 'class' => 'd-inline delete-btn']) !!}
